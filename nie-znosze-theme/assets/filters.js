      ...
      ProductFilters = {
        ...
        bindUIActions: function () {
          ...
          s.filterSectionHandler.find('input[type="checkbox"]').on('click', function (e) {
            ...
            if ($thisParentType == 'filter-property' && (s.filterPropertiesHandler == 'shb-checkbox' || s.filterPropertiesHandler == 'shb-checkbox-color') && s.filterPropertiesMultiple === false) {
              ProductFilters.checkActiveCheckboxOption($this);
            } else if ($thisParentType == 'filter-vendor' && s.filterVendorHandler == 'shb-checkbox' && s.filterVendorMultiple === false) {
              ProductFilters.checkActiveCheckboxOption($this);
            } else if ($thisParentType == 'filter-tags' && s.filterTagsHandler == 'shb-checkbox' && s.filterTagsMultiple === false) {
              ProductFilters.checkActiveCheckboxOption($this);
          ...
          s.filterSingleClearHandler.on('click', function () {
            ...
            if (section.find('input[type="checkbox"]').length) {
              ...
              section.find(s.sliderRangeInputHandler).val(ProductFilters.setRangeValue(s.sliderRangeMinValueDefault, s.sliderRangeMaxValueDefault)).change()
            }
          ...
          s.filterActiveFilterRemove.on('click', function() {
            ...
            if (type.indexOf('properties') !== -1) {
              ...
              selector.find(s.sliderRangeInputHandler).val(ProductFilters.setRangeValue(s.sliderRangeMinValueDefault, s.sliderRangeMaxValueDefault));
            }
        ...
        filterResultsPrice: function () {
          ...
          if (s.filterPriceHandler == 'shb-checkbox') {
            ...
            var priceRange = selector.find(gs.sliderRangeInputHandler).val().split(',');
          ...
          localStorage.removeItem('price_from');
          localStorage.removeItem('price_to');
          if (priceFrom !== '' && priceTo !== '' && Number(priceFrom) !== s.sliderRangeMinValueDefault || Number(priceTo) !== s.sliderRangeMaxValueDefault) {
